/**
 * Seed script — inserts sample hackathons into the database.
 * Run with: npx ts-node src/db/seed.ts  (from the backend/ folder)
 */
...
const hackathons = [
  ...
  },
  {
    ...
    max_team_size: 4,
    registration_url: 'https://climatetechallenge.org',
  },
  {
